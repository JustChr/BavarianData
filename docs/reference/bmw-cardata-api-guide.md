...
# BMW CarData Integration Guide

The complete BMW CarData Integration Guide as published by BMW — registration,
REST API and streaming. The REST half is also kept in
`bmw-cardata-api-reference.md`, the streaming half in `bmw-cardata-streaming-guide.md`.
